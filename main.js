...
ScrollReveal().reveal('.steps-card, .questions-group', {
  interval: 100
});
...
function updateTahun() {
  ...
  // Mengatur ID span dengan nilai tahun saat ini
  document.getElementById("tahun").textContent = tahunSekarang;
}

// Memanggil fungsi updateTahun setiap detik (1000 milidetik)
setInterval(updateTahun, 1000);
